...
export const EditProfileModal: React.FC<EditProfileModalProps> = ({
  ...
  return (
    <ModalShell
      ...
      onClose={handleClose}
      title="Edit Profile"
      subtitle="Institutional Profile Settings"
    ...
    >
      <Animated.View className="pb-8 pt-2" style={{ transform: [{ translateX: formShake }] }}>
        ...
        <Animated.View entering={FadeInDown.delay(100).springify().damping(SPRING_CONFIG.damping)}>
          <FloatingInput
            label="Display Name"
            value={name}
        ...
        <Animated.View entering={FadeInDown.delay(200).springify().damping(SPRING_CONFIG.damping)}>
          <FloatingInput
            ref={emailRef}
        ...
        <Animated.View entering={FadeInDown.delay(300).springify().damping(SPRING_CONFIG.damping)}>
          <FloatingInput
            ref={phoneRef}
        ...
        <Animated.View entering={FadeInDown.delay(400).springify().damping(SPRING_CONFIG.damping)}>
          <FloatingInput
            ref={officeRef}
        ...
        <Animated.View 
          entering={FadeInDown.delay(500).springify().damping(SPRING_CONFIG.damping)}
        ...
        >
          <Pressable
            ...
            style={({ pressed }) => ({
              ...
              transform: [{ scale: (pressed || (canSave && !saving && !saved)) ? 1.05 : 1 }],
            })}
          ...
          >
            {saving ? (
              ...
              <Text className="text-white text-[13px] font-inter-black tracking-[0.5px] uppercase">
