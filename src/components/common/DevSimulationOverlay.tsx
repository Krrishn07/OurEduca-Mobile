...
export const DevSimulationOverlay: React.FC = () => {
  ...
  return (
    <>
      {/* Platinum Dev Pull-Tab — Moved to Right Edge for Zero Collision */}
      <TouchableOpacity 
        onPress={() => setIsVisible(true)}
        className="absolute top-[45%] right-0 w-8 h-16 bg-indigo-600/90 rounded-l-2xl items-center justify-center shadow-2xl z-[999] border-l border-t border-b border-white/30"
        style={{ elevation: 10 }}
      >
        <Icons.Activity size={14} color="white" />
        <View className="mt-1 bg-red-600 rounded-sm px-1 py-0.5 border border-white/50">
