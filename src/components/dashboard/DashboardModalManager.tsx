...
// Centralized Modals
import { 
    AddStudentModal as AddStudentModalMentor, 
    UploadMaterialModal, 
    AnnouncementModal, 
...
import { AddInstituteModal } from '@screens/admin/modals/AddInstituteModal';
import { SecurityPortalModal } from '@screens/platform/modals/SecurityPortalModal';
import { ManageInstituteModal } from '@screens/platform/modals/ManageInstituteModal';
import { NoticeDetailModal } from '@screens/headmaster/modals/NoticeDetailModal';
import { AddClassModal } from '@screens/headmaster/modals/AddClassModal';
import { AddStaffModal } from '@screens/headmaster/modals/AddStaffModal';
import { IssueFeeModal } from '@screens/headmaster/modals/IssueFeeModal';
import { FeeLedgerModal } from '@screens/headmaster/modals/FeeLedgerModal';
import { FeesReportModal } from '@screens/headmaster/modals/FeesReportModal';
...
interface DashboardModalManagerProps {
    ...
    actions: {
        ...
        setClassRoomNo?: (roomNo: string) => void;
            ...
            {(role === UserRole.SUPER_ADMIN || role === UserRole.PLATFORM_ADMIN || (role as any) === 'headmaster') && (
                <>
                    <AddClassModal 
                        ...
                        sections={state.classSections}
                        setSections={actions.setClassSections}
                        subject={state.classSubject}
                        setSubject={actions.setClassSubject}
                        roomNo={state.classRoomNo}
                        setRoomNo={actions.setClassRoomNo}
                        classTime={state.classTime}
                        setClassTime={actions.setClassTime}
                        onAdd={actions.handleSaveClass}
