          ...
          <AppCard className="p-5 border border-gray-100 shadow-sm">
            ...
            {streamSource === 'CCTV' && (
              <View className="mt-4 bg-sky-50 p-4 rounded-2xl border border-sky-100">
                <Text className="text-sky-700 text-[10px] font-black uppercase tracking-widest mb-2 font-inter-black">Security Feed Address</Text>
                   ...
                   <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 }}>
                      ...
                      >
                        <View>
                          ...
                          <Text className="text-white/50 text-[10px] font-inter-black uppercase tracking-widest">
                        ...
                        <View className="items-end">
                          ...
                          <View className="bg-black/60 px-4 py-2 rounded-2xl border border-white/10 backdrop-blur-md items-center">
                            ...
                            <Text className="text-white/30 text-[7px] font-inter-black uppercase tracking-widest">
                              RECORDING
                            </Text>
                          </View>
                          ...
                          <View className="bg-white/10 px-2 py-1 rounded-full mt-3 flex-row items-center">
                              ...
                              <Text className="text-white text-[8px] font-inter-black uppercase tracking-widest ml-1">
                                {viewerCount} Viewers
                              </Text>
                          </View>
                        </View>
    ...
    return (
      <ScrollView className="flex-1 px-4 pt-4" showsVerticalScrollIndicator={false}>
                ...
                >
                  ...
                  <View className="flex-1">
                    ...
                    <View className="flex-row items-center mt-1">
                      ...
                      <Text className="text-emerald-600 text-[10px] font-inter-bold uppercase tracking-widest">
                        Live Feed
                      </Text>
                    </View>
                  </View>
         ...
         <View className="mt-6 px-6 py-4 bg-gray-50 rounded-[24px] border border-gray-100 items-center">
            ...
            <Text className="text-gray-400 text-[9px] font-inter-bold uppercase tracking-widest mt-2 text-center leading-4">
