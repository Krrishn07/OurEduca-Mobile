...
export const PlatformProfile: React.FC<PlatformProfileProps> = ({
  ...
  return (
    ...
    >
        {/* 1. Compact Header Banner — Login-consistent */}
        <View className="relative z-20">
            ...
            {/* Avatar — compact, Login-proportioned */}
        ...
        {/* 2. Profile Header Block — tightened */}
        <View className="px-6 mt-14 mb-5 relative z-10">
            <View className="flex-row justify-between items-start">
                <View className="flex-1 mr-4">
                    ...
                    <StatusPill
                        label={getRoleLabel(currentUser?.role || 'platform')}
                        type="enterprise"
                    />
                </View>
                <TouchableOpacity 
        ...
        <View className="px-4 mb-5">
            ...
            <AppCard className="overflow-hidden p-0">
                ...
                />
                <AppRow
                    title={currentUser?.office || 'Main Platform Hub'}
