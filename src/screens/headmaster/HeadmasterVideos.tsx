...
import { Video, useSchoolData, User } from '@context/SchoolDataContext';
import { PlatformRadius, PlatformTypography } from '@screens/platform/theme';
import { PlatformCard } from '@screens/platform/components/PlatformCard';
